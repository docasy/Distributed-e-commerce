...
CREATE TABLE `tb_address` (
  ...
  `is_default` tinyint DEFAULT '0' COMMENT '默认地址：1-是 0-否',
...
INSERT INTO `tb_address` (`user_id`, `receiver_name`, `receiver_phone`, `province`, `city`, `district`, `detail`, `is_default`) VALUES
(1, '张三', '13800138000', '广东省', '深圳市', '南山区', '科技园南路 88 号', 1),
(1, '李四', '13900139000', '北京市', '北京市', '朝阳区', '望京 SOHO T1 15 层', 0);
